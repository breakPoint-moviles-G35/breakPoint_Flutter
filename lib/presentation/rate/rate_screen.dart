  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Container(height: 120, width: 120, color: Colors.black12),
          ...
          Text(subtitleTop, style: const TextStyle(color: Colors.black87)),
          Text(subtitleBottom, style: const TextStyle(color: Colors.black54)),
          const SizedBox(height: 12),
          OutlinedButton(onPressed: onCreateReview, child: const Text('Create Review')),
        ],
      ),
    );
  }
          ...
          Row(
            ...
            children: List.generate(5, (i) {
              ...
              return IconButton(
                ...
                icon: Icon(idx <= _rating ? Icons.star : Icons.star_border, color: Colors.black87),
              );
            }),
          ),
          const SizedBox(height: 8),
